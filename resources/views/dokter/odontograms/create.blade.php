                ...
                <form action="{{ route('dokter.odontograms.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="pasien_id" id="pasien_id"
                            class="form-control @error('pasien_id') is-invalid @enderror" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nomor_gigi" id="nomor_gigi"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="kondisi_gigi" id="kondisi_gigi"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="occlusi" id="occlusi"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="palatum" id="palatum"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="diastema" id="diastema"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="gigi_anomali" id="gigi_anomali"
